...
charging_stations = pd.read_csv("/app/superconductors/Data/Charging_Stations.csv")
charging_stations= pd.DataFrame(charging_stations)

# Read electric Vehicles data
electric_vehicles = pd.read_csv("/app/superconductors/Data/Electric_Vehicle_Charging_Data.csv")
...
#  Demand vs Capacity trend report for Grid optimization
    ...
    Demand_Trend = pd.read_csv("/app/superconductors/Data/Demand_Trend.csv")
